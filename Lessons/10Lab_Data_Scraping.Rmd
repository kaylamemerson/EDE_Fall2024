...
df_energy <- data.frame("States" = the_states,
                             "Price" = as.numeric(the_price), 
                        "Capacity" = as.numeric(gsub(",", "", 
                                                    the_capacity)),
                        "Net Generation" = as.numeric(gsub(",", "", 
                                                          net_generation)),
                        "Total Retail" = as.numeric(gsub(",", "", 
                                                        total_retail))) %>% 
  filter(States != "U.S. Total")
