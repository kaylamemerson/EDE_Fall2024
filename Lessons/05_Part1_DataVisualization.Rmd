...
PeterPaul.chem.nutrients <- 
  read.csv(file = here("Data/Processed_KEY/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv"), stringsAsFactors = TRUE)
...
```{r, fig.height = 3, fig.width = 4, fog.cap = "Scatterplot", warning = FALSE}
# Scatterplot
