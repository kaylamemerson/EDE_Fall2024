...
# sites$dow <- factor(sites$dow, levels=as.character(seq(1,7))
...
usgs_flow_data <- read.csv(
  file = here('Data','Raw','USGS_Site02085000_Flow_Raw.csv'),
  stringsAsFactors = T,
  colClasses = (c('site_no'='factor')) #converts numbers to factors, stringsAsFactors doesn't do this automatically
)
