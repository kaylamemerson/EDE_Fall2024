...
#make data frame
d1 <- data.frame(c("filename", "date", "source"), c(filename, date, source))

#make kable 
knitr::kable(d1, col.names = c("Item", "Value"), align = c('r', 'l'))
```
...
kable(summary_PM25, col.names = c("County", "$\\mu g/m^3$"), 
      caption = "Mean Particulates (2.5mm)", digits = 2)

#table 2 ~ ozone
kable(summary_Ozone, col.names = c("County", "$\\mu g/m^3$"), 
      caption = "Mean Ozone", digits = 2)
...
```{r 2018 plot, echo=FALSE, fig.align='left', fig.cap="Ozone levels by month in 2018", fig.height=3, message=FALSE, warning=FALSE}
...
```{r 2019 plot, echo=FALSE, message=FALSE, warning=FALSE,  fig.align='left', fig.cap= "Ozone levels by month in 2019", fig.height=3}
